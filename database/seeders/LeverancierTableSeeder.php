...
class LeverancierTableSeeder extends Seeder
{
    public function run(): void
    {
        DB::table('leverancier')->insert([
            ...
            ['naam' => 'Astra Sweets', 'contact_persoon' => 'Jasper del Monte', 'leverancier_nummer' => 'L1029284315', 'mobiel' => '06-28493827', 'is_actief' => true, 'opmerking' => null, 'created_at' => now(), 'updated_at' => now()],
